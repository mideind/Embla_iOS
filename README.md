...
Written in Objective-C for iOS 10.0+. Probably only builds on a recent version of macOS.
...
This program and its source code is &copy; 2019 [Miðeind ehf.](https://miðeind.is) and is released as open source software under the terms and conditions of the [GNU General Public License v3.](https://www.gnu.org/licenses/gpl-3.0.html)
