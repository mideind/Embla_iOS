...
static GPBFileDescriptor *SpeechRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    GPB_DEBUG_CHECK_RUNTIME_VERSIONS();
    descriptor = [[GPBFileDescriptor alloc] initWithPackage:@"lr.speech.v2beta1"
...
GPBEnumDescriptor *RecognitionConfig_AudioEncoding_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        "EncodingUnspecified\000Linear16\000Flac\000OggOpu"
        "s\000Mp3\000Guess\000";
    static const int32_t values[] = {
        ...
        RecognitionConfig_AudioEncoding_Guess,
    };
...
BOOL RecognitionConfig_AudioEncoding_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case RecognitionConfig_AudioEncoding_Mp3:
    case RecognitionConfig_AudioEncoding_Guess:
      return YES;
    default:
      return NO;
  }
...
typedef struct RecognitionMetadata__storage_ {
  ...
  RecognitionMetadata_NumberOfSpeakers numberOfSpeakers;
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .dataTypeSpecific.enumDescFunc = RecognitionMetadata_NumberOfSpeakers_EnumDescriptor,
        .number = RecognitionMetadata_FieldNumber_NumberOfSpeakers,
        .hasIndex = 4,
        .offset = (uint32_t)offsetof(RecognitionMetadata__storage_, numberOfSpeakers),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldHasEnumDescriptor | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeEnum,
      },
      {
...
int32_t RecognitionMetadata_NumberOfSpeakers_RawValue(RecognitionMetadata *message) {
  GPBDescriptor *descriptor = [RecognitionMetadata descriptor];
  GPBFieldDescriptor *field = [descriptor fieldWithNumber:RecognitionMetadata_FieldNumber_NumberOfSpeakers];
  return GPBGetMessageRawEnumField(message, field);
}
...
GPBEnumDescriptor *RecognitionMetadata_NumberOfSpeakers_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        "NumberOfSpeakersUnspecified\000OneSpeaker\000T"
        "woSpeakers\000MultipleSpeakers\000";
    static const int32_t values[] = {
        RecognitionMetadata_NumberOfSpeakers_NumberOfSpeakersUnspecified,
        RecognitionMetadata_NumberOfSpeakers_OneSpeaker,
        RecognitionMetadata_NumberOfSpeakers_TwoSpeakers,
        RecognitionMetadata_NumberOfSpeakers_MultipleSpeakers,
    };
    GPBEnumDescriptor *worker =
        [GPBEnumDescriptor allocDescriptorForName:GPBNSStringifySymbol(RecognitionMetadata_NumberOfSpeakers)
                                       valueNames:valueNames
                                           values:values
                                            count:(uint32_t)(sizeof(values) / sizeof(int32_t))
...
BOOL RecognitionMetadata_NumberOfSpeakers_IsValidValue(int32_t value__) {
  switch (value__) {
    case RecognitionMetadata_NumberOfSpeakers_NumberOfSpeakersUnspecified:
    case RecognitionMetadata_NumberOfSpeakers_OneSpeaker:
    case RecognitionMetadata_NumberOfSpeakers_TwoSpeakers:
    case RecognitionMetadata_NumberOfSpeakers_MultipleSpeakers:
      return YES;
    default:
      return NO;
  }
...
GPBEnumDescriptor *StreamingRecognizeResponse_SpeechEventType_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        ...
        "nce\000StartOfSpeech\000EndOfSpeech\000EndOfAudio"
        "\000";
    static const int32_t values[] = {
        ...
        StreamingRecognizeResponse_SpeechEventType_StartOfSpeech,
        StreamingRecognizeResponse_SpeechEventType_EndOfSpeech,
        StreamingRecognizeResponse_SpeechEventType_EndOfAudio,
    };
    GPBEnumDescriptor *worker =
...
BOOL StreamingRecognizeResponse_SpeechEventType_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case StreamingRecognizeResponse_SpeechEventType_StartOfSpeech:
    case StreamingRecognizeResponse_SpeechEventType_EndOfSpeech:
    case StreamingRecognizeResponse_SpeechEventType_EndOfAudio:
      return YES;
    default:
      return NO;
  }
